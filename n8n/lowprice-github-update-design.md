...
## 목표
망고빙수가 마이리얼트립 파트너 API로 받은 상품 후보를 n8n에서 받아 `SuperGuava/lowprice-kr`의 정적 JSON으로 업데이트한다.
...
- Repo: `SuperGuava/lowprice-kr`
- Branch: `main`
- Update endpoint: `PUT https://api.github.com/repos/SuperGuava/lowprice-kr/contents/{path}`
